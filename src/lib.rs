...
// Re-export history types for command history tracking
pub use history::{
    CURRENT_SCHEMA_VERSION, CommandEntry, DEFAULT_DB_FILENAME, ENV_HISTORY_DB_PATH,
    ENV_HISTORY_DISABLED, HistoryDb, HistoryError, HistoryWriter, Outcome as HistoryOutcome,
};
